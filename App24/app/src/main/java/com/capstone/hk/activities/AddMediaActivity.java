...
import com.capstone.hk.custom.SquareImageView;
import com.capstone.hk.utils.AlertToastManager;
import com.capstone.hk.utils.Base64;
import com.capstone.hk.utils.Constants;
import com.capstone.hk.utils.Session;
import com.capstone.hk.utils.Utils;
import com.capstone.hk.webservices_model.FeedRequestModel;
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            if (isFromMediaActivity) {
                ...
                if (isEditable) {
                    ...
                    Intent resultIntent = new Intent(AddMediaActivity.this, CreatePostActivity.class);
